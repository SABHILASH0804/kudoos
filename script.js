...
const qaPairs = [
  ...
  { q: "All is well.", a: "3 Idiots/nanban" },
  ...
  { q: "I'm going to make him an offer he can't refuse.", a: "The Godfather" },
  { q: "You can't handle the truth!", a: "A Few Good Men" },
  { q: "I'll be back.", a: "The Terminator" },
  { q: "Hasta la vista, baby.", a: "Terminator 2: Judgment Day" },
  { q: "To infinity and beyond!", a: "Toy Story" },
  { q: "With great power comes great responsibility.", a: "Spider-Man" },
  { q: "Keep your friends close, but your enemies closer.", a: "The Godfather Part II" },
  { q: "I am inevitable", a: "Avengers : infinity war" },
  { q: "Paninga kootam varum, singam single-a thaan varum.", a: "Sivaji" },
  { q: "Naan oru thadava sonna, nooru thadava sonna maadhiri.", a: "Baasha" },
  { q: "Oru vaati mudivu pannittena, en pecha naane kekka maaten.", a: "Pokkiri" },
  { q: "ulaga nayagan naan da", a: "dasavatharam" },
  { q: "Kabali da!", a: "Rajinikanth in Kabali" },
  { q: "Naan late-a vandhaalum, latest-a varuven.", a: "baba" }, 
  { q: "Andavan sona , Arunachalam mudichaan", a: "arunachalam" } 
];
